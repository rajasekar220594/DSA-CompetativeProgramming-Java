...
public class AVLTree {
	    ...
	    public static void main(String[] args) {
	        ...
	        */
	        ...
	        -1 2 6
	        */
	        System.out.println("Preorder traversal of constructed tree1 is : ");
	        BinaryTree.preOrder(tree1.root);
	 
	        tree1.root = tree1.deleteNode(tree1.root, 10);
